                ...
                <div class="info">
                    <?php
                        ...
                        if(empty($busqueda)){
                            ...
                            $sql_registe = mysqli_query($conexion, "SELECT COUNT(*) as total_registro FROM usuarios WHERE( Identificacion LIKE '%$busqueda%' OR nombre LIKE '%$busqueda%' OR email LIKE '%$busqueda%' OR telefono LIKE '%$busqueda%')");
                        }
                    ...
                    <table>
                        ...
                        <?php
                            $query = mysqli_query($conexion, "SELECT * FROM producto WHERE( Identificacion LIKE '%$busqueda%' OR nombre LIKE '%$busqueda%' OR email LIKE '%$busqueda%' OR telefono LIKE '%$busqueda%')");
