		...
		<tr>
			...
			<td class="info_empresa">
				...
				<div>
					...
					<p><?php echo $configuracion['razonSocial']; ?></p>
			...
			<td class="info_factura">
				<div class="round">
					...
					<p>No. Factura: <strong><?php echo $factura['nFactura']; ?></strong></p>
			...
			<td class="info_cliente">
				<div class="round">
					...
					<table class="datos_cliente">
						<tr>
							<td><label>Nit:</label><p><?php echo $factura['identificacion']; ?></p></td>
			...
			<?php
			 ...
			 ?>
				<tr>
					...
					<td class="textright"><?php echo $row['precioVenta']; ?></td>
